...
## 说明
这是 `OPC Industry KB` 的第一个垂直行业落地方向。

选择招聘行业，是因为它天然符合 OPC 场景：
- 文档工作多
- 重复任务多
- 经验型判断多
- 模板和 SOP 可复用性强
...
这个垂直版本的目标，不是替代 ATS，而是先做一个真正有用的 **招聘工作副驾**。

---

## 定位
把招聘行业的术语、岗位知识、客户需求、候选人评估、推荐报告、跟进流程，沉淀为可被 AI 稳定调用的生产系统。
...
- `verticals/recruiting/ai-application-engineer/sell-pack/internal-process-automation/real-pilot-design.md`（真实试点流程设计）
- `apps/internal-process-automation-pilot/`（第一版本地试点 UI）
